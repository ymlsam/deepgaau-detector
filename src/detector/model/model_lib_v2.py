...
def eager_train_step(detection_model,
    ...
    trainable_variables = var_util.filter_train_vars(detection_model.trainable_variables, train_config.update_trainable_variables, train_config.freeze_variables)
...
def load_fine_tune_checkpoint(
    ...
    # ////
    box_predictor_ckpt = tf.compat.v2.train.Checkpoint(
    ...
    custom_model_ckpt = tf.compat.v2.train.Checkpoint(
        _feature_extractor=model._feature_extractor,
        _box_predictor=box_predictor_ckpt)
    ckpt = tf.compat.v2.train.Checkpoint(model=custom_model_ckpt)
